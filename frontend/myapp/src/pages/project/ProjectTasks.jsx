  ...
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full border rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
              />
            </div>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-6 py-2 bg-black text-white text-sm rounded-lg hover:bg-gray-800 disabled:bg-gray-300 flex items-center gap-2"
              >
                {isCreating ? (
                  <>
      ...
      <div className="bg-white rounded-lg border p-6">
        <TaskBoard projectId={projectId} refreshTrigger={refreshBoard} />
      </div>
